          ...
          {(mode === "login" || mode === "signup") && (
            <>
              ...
              <button
                ...
                className="w-full py-2 bg-surface text-on-surface font-semibold rounded-md border border-outline/30 shadow-1 hover:bg-surface-variant/10 hover:shadow-2 hover:scale-[1.01] active:scale-[0.99] transition-all duration-200 flex items-center justify-center gap-2 disabled:opacity-50"
              >
                {isGoogleLoading ? (
                  <>
